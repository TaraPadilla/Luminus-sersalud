        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Validar rol RegistroHuellaMedica
                    ...
                    // Validar rol Medico Externo
                    bool esMedicoExterno = await _userManager.IsInRoleAsync(user, "Medico Externo");
                    if (esMedicoExterno)
                    {
                        return LocalRedirect("/Hospitalizacion/Habitaciones");
                    }
