...
//                     paciente.Email = viewModel.Correo;
...
//         public IActionResult CalendarioLineal(string buscar, string buscar2, int? sucursalId, int? empleadoId, int? especialidadId, int? servicioId, string pacienteNombre)
//         {
//             // Mantener el valor del input de paciente al recargar
