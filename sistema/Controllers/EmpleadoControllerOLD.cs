...
//                 }
//                 {
//                     var nuevo = (model.Empleado.Telefono_3 ?? string.Empty).Trim();
//                     var viejo = (empleadoDb.Telefono_3 ?? string.Empty).Trim();
//                     if (!string.Equals(viejo, nuevo, StringComparison.Ordinal))
//                     {
//                         empleadoDb.Telefono_3 = string.IsNullOrWhiteSpace(nuevo) ? null : nuevo;
//                         cambios.Add(nameof(empleadoDb.Telefono_3));
//                     }
//                 }
